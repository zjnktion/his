...
public class SYTFPanel extends JPanel {
    ...
    public SYTFPanel(int contentWidth, int contentHeight) {
        super(null);
        ...
        this.yaopinHeight = contentHeight - searchHeight - resultHeight;
        this.readHeight = 200;
    ...
    private void initSearchPanel() {
        ...
        JLabel numLabel = new JLabel("门诊号：");
        ...
        JLabel codeLabel = new JLabel("收费单编码：");
        ...
        JLabel icnumLabel = new JLabel("社保号：");
    ...
    private void initResultPanel() {
        ...
        int baseX = 20;
        int baseY = 20;
        resultTable = new JTable(new Object[][]{{"201709010012", "zjn", "12", "男", "2017-09-01", "退费"}, {"201709010012", "zjn", "12", "男", "2017-09-01", "退费"}}, new Object[]{"收费单编码", "姓名", "门诊号", "性别", "收费时间", "操作"});
    ...
    private void initYaopinPanel() {
        ...
        yaopinPanel.setBounds(0, searchHeight + resultHeight, contentWidth - readWidth, yaopinHeight);
